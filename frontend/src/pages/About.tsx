    ...
    return (
        <div id="about-page">
            ...
            <div className="timeline">
                <TimelineItem date="2025" title="Founded" side="left">
                    <p>MP Partners was founded by Bocconi University students with the goal of supporting companies, start-ups, and alternative investment operators, particularly within the sports, media, and innovation industries, in developing strategic and growth-oriented projects.</p>
                </TimelineItem>
